...
\Section{Encryption}
Titkosítással kapcsolatos osztályokat tartalmaz.
...
\Section{GUIRelated}
A csomag olyan osztályokat tartalmaz, amelyek a grafikus felhasználói felület személyre szabásában segítettek. 
